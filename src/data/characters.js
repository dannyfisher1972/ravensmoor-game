...
const META = {
  ...
  'Marcus Thorne': {
    ...
    answers: {
      ...
      suspicionMedical: "Julian owes money to people who don't send polite reminders. Though if it really was just his heart, I suppose that's one less thing anyone needs to answer for.",
  ...
  'Harriet Voss': {
    ...
    answers: {
      ...
      suspicionMedical: "Marcus has his father's temper without his father's patience. Though if his heart just gave out, I suppose none of that temper matters tonight.",
  ...
  'Julian Voss': {
    ...
    answers: {
      ...
      suspicionMedical: "Nathaniel's redrafted that will more times than anyone talks about. Though if it really was just his heart, I suppose the will speaks for itself now.",
  ...
  'Nathaniel Cole': {
    ...
    answers: {
      ...
      suspicionMedical: "I'd look harder at whoever benefits most from the version of the will he never got to sign. Though if it was simply his heart, I suppose the will settles the rest on its own.",
  ...
  'Eleanor Pemberton': {
    ...
    answers: {
      ...
      suspicionMedical: "I try not to speculate about the family I serve. Though if it really was just his heart, I suppose there's nothing here to speculate about after all.",
  ...
  'Vivienne Thorne': {
    ...
    answers: {
      ...
      suspicionMedical: "That woman he replaced me with is hiding something. Though if it really was just his heart, I suppose even she can't take credit for that.",
  ...
  'Tom Yarrow': {
    ...
    answers: {
      ...
      suspicionMedical: "Not my place to say. I mind the hedges, not the house — and if it really was just his heart, that's between him and Dr. Wren, not me.",
